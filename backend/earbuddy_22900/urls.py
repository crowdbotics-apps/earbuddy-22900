"""earbuddy_22900 URL Configuration
...
admin.site.site_header = "Earbuddy"
admin.site.site_title = "Earbuddy Admin Portal"
admin.site.index_title = "Earbuddy Admin"

# swagger
api_info = openapi.Info(
    title="Earbuddy API",
    default_version="v1",
    description="API documentation for Earbuddy App",
)
